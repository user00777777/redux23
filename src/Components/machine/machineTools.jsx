...
// console.log(stateMashine);
  ...
  return (
    <div className={s.parent }ref={fatherRef}>
      ...
      <div></div>
      <div className={[s.div6,s.radialka].join(' ')}><Link to='/radialka'>2А554</Link>
      <Link to='/radialka'><span>№52035</span></Link> 
      </div>
      {/* <div className={[s.div7].join('')}>11</div> */}
      {/* <div className={[s.div8].join('')}>1</div> */}
      <div className={[s.div9,s.radialka].join(' ')}><Link to='/radialka'>2А554</Link>
      <Link to='/radialka'><span>№5268</span></Link> 
      </div>
      <div className={[s.div10,s.sm2126].join(' ')}>СМ2126 <Link to='/radialka'><span>№52050</span></Link></div>
      <div className={[s.div11,s.sb833].join(' ')}>СБ833<Link to='/radialka'><span>№52056</span></Link></div>
      <div className={[s.div12,s.sb972].join(' ')}>СБ972<Link to='/radialka'><span>№52910</span></Link></div>
      <div className={[s.div13,s.sm2126].join(' ')}>СМ2126<Link to='/radialka'><span>№52049</span></Link></div>
      <div className={[s.div14,s.sb833].join(' ')}>СБ833<Link to='/radialka'><span>№52055</span></Link></div>
      <div className={[s.div15,s.sb972].join(' ')}>СБ972<Link to='/radialka'><span>№52911</span></Link></div>
      <div className={[s.div16,s.klepka].join(' ')}>Клепка<Link to='/radialka'><span>№52131</span></Link></div>
      <div className={[s.div17,s.klepka].join(' ')}>Клепка<Link to='/radialka'><span>№52155</span></Link></div>
      <div className={[s.div18,s.radialka].join(' ')}>2А554<Link to='/radialka'><span>№51773</span></Link></div>
      <div className={[s.div19,s.radialka].join(' ')}>2Н55<Link to='/radialka'><span>№1705</span></Link></div>
      <div className={[s.div20,s.klepka].join(' ')}>Клепка<Link to='/radialka'><span>№51791</span></Link></div>
      <div className={[s.div21,s.klepka].join(' ')}>Клепка<Link to='/radialka'><span>№51814</span></Link></div>
      <div className={[s.div22,s.t].join(' ')}>Телега --- <Link to='/radialka'><span>  №051973</span></Link>---</div>
      <div className={[s.div23].join('')}>ШУ<Link to='/radialka'><span>телеги</span></Link></div>
      <div className={[s.div24,s.sb972].join(' ')}>Am19176<Link to='/radialka'><span>№52333</span></Link></div>
      ...
      <div className={[s.div51].join('')}>телега<Link to='/radialka'><span>№052087</span></Link></div>
      {/* <div className={[s.div52].join('')}>3<Link to='/radialka'><span></span></Link></div> */}
      <div className={[s.div53,s.klepka].join(' ')}>клепка<Link to='/radialka'><span>№51109</span></Link></div>
      <div className={[s.div54,s.radialka].join(' ')}>2Н55<Link to='/radialka'><span>№2653</span></Link></div>
      <div className={[s.div55,s.sb832].join(' ')}>СБ832<Link to='/radialka'><span>№052051</span></Link></div>
      <div className={[s.div56].join('')}>Дорога<Link to='/radialka'><span></span></Link></div>
      <div className={[s.div57,s.radialka].join(' ')}>2Н55<Link to='/radialka'><span>№11917</span></Link></div>
      {/* <div className={[s.div58].join('')}>3<Link to='/radialka'><span></span></Link></div> */}
      <div className={[s.div59].join('')}>ФП27П<Link to='/radialka'><span>№52232</span></Link></div>
      ...
      <div className={[s.div63].join('')}>СМ2414<Link to='/radialka'><span>№52800</span></Link></div>
      ...
      <div className={[s.div67].join('')}>2Н135<Link to='/radialka'><span>№51776</span></Link></div>
      <div className={[s.div68].join('')}>2С 132<Link to='/radialka'><span>51772</span></Link></div>
