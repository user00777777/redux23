...
<div data-hoist='51833'data-rp='' data-machine='См2126<br><span>№052049<span/>' className={[s.div18,s.t,'t'].join(' ')}> 51833</div>
<div data-hoist='51832'data-rp='' data-machine='СБ833<br><span>№052056<span/>' className={[s.div19,s.t,'t'].join(' ')}> 51832</div>
<div data-hoist='51922'data-rp='' data-machine='2A554<br><span>№051773<span/>' className={[s.div20,s.t,'t'].join(' ')}> 51922</div>
<div data-hoist='51924'data-rp='' data-machine='2H55<br><span>№1705<span/>' className={[s.div21,s.t,'t'].join(' ')}> 51924</div>
<div data-hoist='51770'data-rp='' data-machine='СБ833<br><span>№052055<span/>' className={[s.div22,s.t,'t'].join(' ')}> 51770</div>
<div data-hoist='51871'data-rp='' data-machine='SB972<br><span>№052910<span/> ' className={[s.div23,s.t,'t'].join(' ')}> 51871</div>
