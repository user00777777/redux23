...
import repairTel from './Telphers/RepairTel'
...
const initialState = {
	data: [
		...
		{ hoist: '51770', rp: 12, foto: '', avt: 'шр возле буксового' },
		{
			...
			rp: 12,
			foto: '',
			avt: 'шр возле буксового',
			// repair: repairTel('51792'),
		},
...
const mySlice = createSlice({
	...
	reducers: {
		...
		getTelf(state, action) {
			...
			let res = data.data.find(el => el.hoist == action.payload)
		console.log(res)
 state.o=res
// return state
		console.log(data)
...
export const { setData, getTelf } = mySlice.actions
