...
<div className={[s.div7,s.avm1,s.r].join(' ')}> Авм №1</div>
...
<div className={[s.div13,s.connection,s.r].join(' ')}> </div>
...
<div className={[s.div17,s.avm2,s.r].join(' ')}> <h4>Авм2</h4></div>
...
<div className={[s.div28,s.door,s.r].join(' ')}> дверь на 7 пр</div>
<div className={[s.div29,s.door,s.r].join(' ')}> дверь на 7 пр</div>
