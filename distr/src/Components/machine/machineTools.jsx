...
// Создание контекста
  ...
  return (
    <div><div className={[s.parent,s.empty].join('')}>
    <div className={[s.div1,s.m].join(' ')}>xdxxd </div>
    <div className={[s.div2].join(' ')}> </div>
    <div className={[s.div3,s.m].join(' ')}> </div>
    <div className={[s.div4,s.mm].join(' ')}> </div>
    <div className={[s.div6].join(' ')}> </div>
    <div className={[s.div5].join(' ')}> </div>
    <div className={[s.div7 ,s.way].join(' ')}> </div>
